...
function NavBar() {
    ...
    const list1 = (anchor) => (
        ...
        >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px', backgroundColor: '#333', color: '#fff' }}>
                <div style={{ fontSize: 35 }}><InventoryIcon fontSize='large' />&nbsp;&nbsp;{location.pathname.split('/')[1] == 'billing' ? 'billing' : ''}</div>
                <Button onClick={toggleDrawer(anchor, false)} color="inherit">
                    <ArrowBackIcon fontSize='small' />
                </Button>
            </Box>
            ...
            <List>
                    <>
                        ...
                        <ListItem key={1}>
                            <ListItemButton to="/billing/Dashboard">
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                        ...
                        <ListItem key={1}>
                            <ListItemButton to="/billing/Category">
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                        ...
                        <ListItem key={1}>
                            <ListItemButton to="/billing/Unit">
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                        ...
                        <ListItem key={1}>
                            <ListItemButton to="/billing/SubCategory">
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                        ...
                        <ListItem key={1}>
                            <ListItemButton to="/billing/MenuCategory">
                                <ListItemIcon>
                                    <DashboardIcon />
                                </ListItemIcon>
                                ...
                                <div>
                                    {['left'].map((anchor) => (
                                        <React.Fragment key={anchor}>
                                            ...
                                            >
                                                {location.pathname.split('/')[1] === 'billing' ? list1(anchor) : list(anchor)}
                                            </Drawer>
                                        </React.Fragment>
                                    ))}
                                </div>
